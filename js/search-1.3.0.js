...
function openSearchSuite() {
    ...
    if (iChildCount == 0) {
        url = 'http://www.inntopia.travel/aspnet/09/search.aspx?salesid=1321967&arrivaldate=' + arrival +
                '&sortcode=p&locationid=1307437&departuredate=' + dep +
                '&adultcount=' + persons;
    }
    else {
...
function openSearchLowHigh() {
    ...
    var path = window.location.pathname;
    _gaq.push(['_trackEvent', 'search accomm', 'search', path], ['_link', url]);
 //   _gaq.push(['_link', url]);
...
function search_start() {
    ...
    $(".datepicker3").datepicker().val(AddToTodaysDate(3).toString()).trigger('change');
    ...
    $(".datepicker4").datepicker().val(AddToTodaysDate(3).toString()).trigger('change');
    ...
    $(".datepicker5").datepicker().val(AddToTodaysDate(3).toString()).trigger('change');
    ...
    $(".datepicker6").datepicker().val(AddToTodaysDate(3).toString()).trigger('change');
    ...
    $(".datepicker7").datepicker().val(AddToTodaysDate(3).toString()).trigger('change');
    ...
    $(".datepicker8").datepicker().val(AddToTodaysDate(3).toString()).trigger('change');
...
function search_start_activity() {
    ...
    $(".datepicker1").datepicker().val(AddToTodaysDate(2).toString()).trigger('change');
    $(".datepicker2").datepicker({
        numberOfMonths: 1,
        showAnim: "",
        showOn: 'focus',
...
function search_start_golf() {
    ...
    $(".datepicker1").not(".hasDatepicker").datepicker({
        numberOfMonths: 1,
        showAnim: "",
        showOn: 'focus',
        buttonImageOnly: true,
...
function openSearchActivity2() {
    ...
    //                _gaq.push(['_link', url]);
  //  _gaq.push(['_trackEvent', 'transport', 'search', path], ['_link', url]);
_gaq.push(['_trackEvent', 'search transfer', path, code], ['_link', url]);
...
_gaq.push(['_trackEvent', 'search rental', path, code], ['_link', url]);
}

function openSearchGolf() {
    var arrival = jQuery('#arrival').val();
    var catid = jQuery('#selectActivity').val();
    var dep = jQuery('#departure').val();
    var path = window.location.pathname;
    ...
    //_gaq.push(['_link', url]);
    //  _gaq.push(['_trackEvent', 'rental', 'search', path], ['_link', url]);
    _gaq.push(['_trackEvent', 'search golf', path, code], ['_link', url]);
}
function openSearchGolf_New() {
    ...
    //_gaq.push(['_link', url]);
    //  _gaq.push(['_trackEvent', 'rental', 'search', path], ['_link', url]);
    _gaq.push(['_trackEvent', 'search golf new', path, code], ['_link', url]);
}
