...
function search_activity() {
    // activity - supercatid 2
    var arrival = $('#inpage-widget .arrival').val(), 
		departure = $('#inpage-widget .departure').val(), 
		catid = $('#inpage-widget #selectActivity').val(), 
		path = window.location.pathname, 
		url, 
		code = $('#inpage-widget #selectActivity option:selected').text();
