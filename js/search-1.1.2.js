   ...
   // rental - supercatid 6
      ...
      function openSearchAll() {
          ...
          if (home == 0) {
              ...
              home1 = '&features=P,500,1,1';
          }
          else if (home == 2) {
              home1 = '&features=P,500,5,1';
          }
          else if (home == 3) {
              home1 = '&features=P,500,8,1';
          }
          else if (home == 4) {
              home1 = '&features=P,500,8,1';
          }
          ...
          if (iChildCount == 0) {
              ...
              url = 'http://www.inntopia.travel/aspnet/09/search.aspx?salesid=1321967&arrivaldate=' + arrival +
                '&departuredate=' + dep +
                '&adultcount=' + persons +
                '&NeighbourhoodId=' + neighbour + feature1 + home1;
          }
          else {
              ...
              url = 'http://www.inntopia.travel/aspnet/09/search.aspx?salesid=1321967&arrivaldate=' + arrival +
               ...
               '&NeighbourhoodId=' + neighbour +
                '&childcount=' + iChildCount +
                '&childagearray=' + CreateChildArray(iChildCount) + feature1 + home1;
          }
          _gaq.push(['_link', url]);
