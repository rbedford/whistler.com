...
function search_start_transport_new() {
    ...
    $(".datepicker3").datepicker().val(AddToTodaysDate(2).toString()).trigger('change');
    ...
    $(".datepicker4").datepicker().val(AddToTodaysDate(2).toString()).trigger('change');
...
function search_start_activity_new() {
    ...
    $(".datepicker5").datepicker().val(AddToTodaysDate(2).toString()).trigger('change');
    ...
    $(".datepicker6").datepicker().val(AddToTodaysDate(2).toString()).trigger('change');
    //     var catid = jQuery('#acatid').val();
    //     jQuery('#selectActivity').val(catid);
}
...
function search_start_rental_new() {
    ...
    $(".datepicker7").datepicker().val(AddToTodaysDate(4).toString()).trigger('change');
    ...
    $(".datepicker8").datepicker().val(AddToTodaysDate(4).toString()).trigger('change');
    //     var catid = jQuery('#acatid').val();
    //     jQuery('#selectActivity').val(catid);
}
...
function flight_start_new() {
    ...
    $(".adatepicker1").datepicker().val(AddToTodaysDate(2).toString()).trigger('change');
    ...
    $(".adatepicker2").datepicker().val(AddToTodaysDate(4).toString()).trigger('change');
    $("#aadult").val('2');
